...
public final class TaskLogContext {
     ...
     * @return 步骤句柄
     */
    public static TaskStep startStep(String stepName, Object... params) {
        ...
        TaskLogRecord record = new TaskLogRecord(
            context.jobLogId,
            stepNo,
            StrUtil.format(stepName, params),
        ...
        return new TaskStep(publisher, detailId, context.jobLogId, stepNo, StrUtil.format(stepName, params), startTime);
    }
    ...
    public static final class TaskStep implements AutoCloseable {
        ...
        public void info(String message, Object... params) {
            publishInfo(TaskStepStatus.INFO, StrUtil.format(message, params));
        }
         ...
         * @param message 跳过原因
         */
        public void skipped(String message, Object... params) {
            publishInfo(TaskStepStatus.SKIPPED, StrUtil.format(message, params));
        }
        ...
        public void success(String message, Object... params) {
            finish(TaskStepStatus.SUCCESS, StrUtil.format(message, params), null);
        }
         ...
         */
        public void needsAuth(String message, Object... params) {
            finish(TaskStepStatus.NEEDS_AUTH, StrUtil.format(message, params), null);
        }
        ...
        private void publishInfo(String status, String message) {
